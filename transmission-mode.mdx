...
date: "2022-12-11"
tags: ["network", "computer-network"]
---

Transmission mode adalah mekanisme transfer/pertukaran data antara dua devices pada suatu network. Mode ini merupakan mode bagaimana arus pertukaran suatu data. Terdapat 3 jenis mode transmisi:

- Simplex Mode
- Half Duplex Mode
- Full Duplex Mode

## Perbedaan Antar Jenis Mode Transmisi
